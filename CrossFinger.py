...
outcome_buffer = deque(maxlen=30)  # Store outcomes for approximately 3 seconds (assuming 10 fps)
last_time = time.time()
...
with mp_hands.Hands( #ข้อมูลมือ
  ...
  while capture.isOpened(): #เมื่อเปิดกล้อง
    ...
    #        turn_on += 1
    #        count2 += 1
    #     elif outcome == "turnOff":
    #        turn_off += 1
    #        count2 += 1
    #     elif outcome == "end":
    #        end += 1
    #        count2 += 1
    #     elif outcome == "increase":
    #        break
    #     elif outcome == "decrease":
    #        break
    if outcome:
    ...
    # i+=1
    # print("light",light)
    # if outcome != "increase" and outcome != "decrease" and count2>=100:
    ...
    cv2.putText(image, str(mode+' '+final_outcome), (50,450), cv2.FONT_HERSHEY_COMPLEX_SMALL, 3, (255,0,0), 10) #แสดงจำนวนนิ้วที่นับได้บนภาพ
